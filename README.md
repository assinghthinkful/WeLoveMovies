...
Follow the instructions below to get this project up and running on your own machine: Note: This project will not deploy properly without additional configuration. You do NOT need to deploy it to finish this assignment.
...
Instructions are included there on how to get the project up and running. Running tests
...
Seed data is included in this project in the ./src/db/seeds folder. The seeds will run correctly if and only if the tables are setup as described in the previous documents. Routes
